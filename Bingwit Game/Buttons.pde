...
PImage play, levels, backhome, lvlbg, lvl1, lvl2, lvl3, store, pause, resume, restart, buy, backstore;
...
int buyBtn2X = 445, buyBtn2Y = 420; //speedyrod
  ...
  void mousePressed() {
    ...
    if ((gameState == 2 || gameState == 6) && isHover(backHmLvlX, backHmLvlY, backHmW, backHmH)) {
      gameState = 0;
      clickedAButton = true;
    }
